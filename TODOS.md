...
- [ ] **Medium — export hygiene:** filenames use UTC `toISOString().slice(0,10)`; money in CSV should keep 2dp; `downloadSummaryCsv` in Reports.jsx still uses inline CSV escaping (will migrate to shared lib when created)
