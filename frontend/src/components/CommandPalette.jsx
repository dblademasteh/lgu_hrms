...
const pages = [
  ...
  { label: 'Performance', path: '/performance', icon: BarChart3, roles: HR_LEAD, capability: 'performanceRead' },
  { label: 'IPCR/OPCR', path: '/ipcr', icon: FileText, roles: HR_LEAD, capability: 'performanceRead' },
