...
import { createDisqualificationSchema, updateDisqualificationSchema, disqualificationIdSchema, disqualificationReportSchema, listDisqualificationsSchema } from '../shared/contracts/disqualification.js';

const router = Router();

router.get('/', requirePermission('disqualificationCRUD'), validate(listDisqualificationsSchema), disqualificationController.list);
