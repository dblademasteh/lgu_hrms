...
import biometricDevicesRouter from './biometricDevices.js';
...
import vacancyPublicationsRouter from './vacancyPublications.js';
...
router.use('/biometric-devices', biometricDevicesRouter);
...
router.use('/vacancy/:vacancyId/publications', vacancyPublicationsRouter);
